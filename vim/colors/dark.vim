" Colorscheme based on https://github.com/chriskempson/base16-vim/blob/master/colors/base16-solarized-dark.vim
...
exec 'hi VisualNOS                              ctermbg='.s:color_bg_accent.' cterm=none'
