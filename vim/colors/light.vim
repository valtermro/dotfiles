...
exec 'hi ColorColumn       ctermbg='.s:color_bg_visual.' cterm=none'
exec 'hi CursorColumn      ctermbg='.s:color_bg_visual.' cterm=none'
exec 'hi CursorLine        ctermbg='.s:color_bg_visual.' cterm=none'
...
exec 'hi PMenu             ctermfg='.s:color8.' ctermbg='.s:color_bg_visual
...
unlet s:color_fg_normal s:color_bg_visual s:color_fg_accent s:color_bg_accent
"= endsection }}}1
